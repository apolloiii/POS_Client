...
//public class MapFloor4 extends Fragment implements View.OnLongClickListener,
...
//	}
//
//	public ArrayList<Itable> check(List<Itable> list) {
//		/*
...
//		// hai sua doan nay , bi double ban khi click add
//
//		/*
//		 * while (lstTable.hasNext()) { Itable itable = lstTable.next(); if
//		 * (itable != null) {
//		 */
//		if (addflag == true) {
...
//				DragLayer.LayoutParams lp = new DragLayer.LayoutParams(w, h,
//						left, top);
...
//				if (itable != null) {
//					/*
//					 * ArrayList<Itable> itablearr = check((ArrayList<Itable>)
//					 * list); for (Itable itable : itablearr) {
//					 */
//
//					TextView newView = new TextView(getActivity());
//					newView.setTag(itable.getCode_table().toString());
...
//					int top = itable.getPos_y();
//					Log.d("========================================", "");
//					Log.d("=====itable.getPos_x :", itable.getPos_x()+"");
//					Log.d("=====itable.getPos_y :", itable.getPos_y()+"");
//					Log.d("========================================", "");
//					
...
//
//	/**
//	 * Hàm lấy heigth + width của màn hình
//	 * xét vị trí cho nút add table luôn luôn hiển thị trên màn hình
//	 */
//	private void getHeightWidth() {
//		DisplayMetrics displayMetrics = new DisplayMetrics();
//		WindowManager wm = (WindowManager) getActivity().getSystemService(
//				Context.WINDOW_SERVICE); // the results will be higher than
//											// using the activity context object
//											// or the getWindowManager()
//											// shortcut
...
//		
//		Log.i("===================================", "");
//		Log.i("DefaultDisplay:",width +" - "+height);
//		Log.i("===================================", "");
//		
...
//				new WSInsertTable(getActivity(), ConfigurationServer.floor) .execute();
//				addflag = true;
//			}
//		});
//		img.setBackgroundResource(R.drawable.selector_footer_add);
//		
//		DragLayer.LayoutParams lp = new DragLayer.LayoutParams(50, 50, width - 200, height - 280);
...
//			new WSClickTable(getActivity(), code_table,  MainPosActivity.user_id ) .execute();
//		}
//
//	}
//
...
//
//    	Toast.makeText(getActivity(), "onTouch Dòng 570 MapFloor4", Toast.LENGTH_SHORT).show();
//    	
//		if (mLongClickStartsDrag)
//			return false;
...
//							+ " Size of table beanDataAll"));
//			Log.d("thuan",
//					String.valueOf(tmpItablelst.size()
//							+ " Size of table tmpItablelst"));
//		}
//	}
//
