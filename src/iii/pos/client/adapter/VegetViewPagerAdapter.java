...
import iii.pos.client.fragment.GridVegetFragment;
...
public class VegetViewPagerAdapter extends FragmentStatePagerAdapter {

	private ArrayList<Items> lstItemsWine;
	private int mNumItemsWine = 0;
	private int mNumFragmentsWine = 0;

	public VegetViewPagerAdapter(FragmentManager fm, ArrayList<Items> lstItems) {
		super(fm);
		setup(lstItems);
	}
	...
	public Fragment getItem(int position) {
		...
		GridVegetFragment f = new GridVegetFragment();
