...
public class CategorySlideWineAdapter extends BaseAdapter {
	...
	// ===============constructor=============================//
	public CategorySlideWineAdapter(Activity context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflate
					.inflate(R.layout.category_slide_custom2, null);
		...
		// Bitmap bm = getImageBitmap(context, category.getImgname());//
