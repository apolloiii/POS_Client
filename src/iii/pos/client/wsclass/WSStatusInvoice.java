...
public class WSStatusInvoice extends AsyncTask<Void, Void, Void> {
	...
	// --------constructor-----------------------------//
	public WSStatusInvoice(Context mContext, String inv_code, float vat, float com,
